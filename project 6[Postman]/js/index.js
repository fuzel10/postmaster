console.log('Welcome to postman clone website');
...
// Hides the parameters box initially
...
addParam.addEventListener('click',()=>{
    ...
    let string =`<div class="form-row my-3">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" id=" ${addedParamCount + 2}" placeholder="Enter parameter  ${addedParamCount + 2} Key">
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control" id=" ${addedParamCount + 2}" placeholder="Enter parameter  ${addedParamCount + 2} Value">
                        </div>
...
submit.addEventListener('click',()=>{
    ...
    console.log("the responseType is :", data);
